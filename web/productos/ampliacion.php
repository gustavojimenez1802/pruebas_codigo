...
?>
<?php
$info = $producto."/info.php"; 
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
<head>
<title>Productos disponibles en Brcmedia.com. Producto: <?php echo $producto; ?></title>
<link rel="shortcut icon" href="http://www.brcmedia.com/favicon.ico">
<meta name="description" content="Galería de productos flash flv realizados por Brcmedia diseño web diseño gráfico diseño de camisetas programación">
<meta name="keywords" content="Productos,fotos,videos,video,diseño,web,flash,programación,camisetas,textil,fotografía">
            ...
            <tr>
              <td width="266" valign="top">&nbsp;<br>
                  <table width="260" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><p><strong><font color="#232929">Listado de productos</font></strong><font color="#232929"><br>
                        <br>
              ...
              <td width="649" align="center" valign="top"><table width="615" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><p><br>
                      <img src="../imagenes/titproductos.jpg" alt="Produtos brcmedia.com" width="599" height="30"></p>
                      <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td valign="top"> <p><strong>Producto título: <?php echo $producto; ?></strong></p>
                            <p><img src="<?php echo $producto; ?>/foto.jpg" alt="Fotografía <?php echo $producto; ?>" width="600" height="400"><br>
                              <noscript>
                                </noscript>
                                                      </p>
                            <p><strong>
                        ...
                        <p><img src="../imagenes/flechavolver.gif" alt="Volver a la página anterior" width="4" height="8"> <strong><a class="brcmedia" href="javascript:window.history.back();" title="Volver a la p&aacute;gina anterior">Volver a la sección de productos</a></strong></p>
                          </td>
                        </tr>
                      </table>
                      <p>&nbsp;</p>
