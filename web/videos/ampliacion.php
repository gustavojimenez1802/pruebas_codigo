...
<html>
<head>
<title>Vídeos realizados por Brcmedia.com. vídeo: <?php echo $video; ?></title>
<link rel="shortcut icon" href="http://www.brcmedia.com/favicon.ico">
<meta name="description" content="Galería de videos flash flv realizados por Brcmedia diseño web diseño gráfico diseño de camisetas programación">
<meta name="keywords" content="videos,video,diseño,web,flash,programación,camisetas,textil,fotografía">
...
<table width="955" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><img src="../imagenes/bannerbrcmedia.jpg" alt="Libros librerías escritores brcmedia" width="955" height="147"></td>
      </tr>
    </table>
    <table width="955" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
            ...
            <tr>
              <td width="266" valign="top">&nbsp;<br>
                  <table width="260" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><p><strong><font color="#232929">Listado de vídeos realizados</font></strong><font color="#232929"><br>
                        <br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Trabajos de diseño web<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Trabajos en programación<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Trabajos web<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Trabajos en diseño gráfico<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Trabajos en papel<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Carteles<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Láminas decorativas<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Pósters y murales<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Diseño de camisetas<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Diseño industrial<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Galerías fotográficas<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Trabajos de diseño web<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Trabajos en programación<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Trabajos web<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Trabajos en diseño gráfico<br>
                        ...
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Diseño de camisetas<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Diseño industrial<br>
                        <img src="../imagenes/flecha3.gif" alt="Venta de libros librerías escritores" width="4" height="8"> Galerías fotográficas</font></p>
                      <p>&nbsp;</p></td>
                    </tr>
                </table></td>
              <td width="649" align="center" valign="top"><table width="615" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><p><br>
                      <img src="../imagenes/titvideos.jpg" alt="Galería de vídeos brcmedia.com" width="599" height="30"></p>
                      <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td valign="top"> <strong>Vídeo título: <?php echo $video; ?></strong><br>
                            <script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','600','height','450','title','Vídeos brcmedia.com','src','<?php echo $video; ?>/brcmedia','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','menu','false','movie','<?php echo $video; ?>/brcmedia' ); //end AC code
                    </script>
                      <noscript>
                        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="600" height="450" title="Vídeos brcmedia.com <?php echo $video; ?>">
                        <param name="movie" value="<?php echo $video; ?>/brcmedia.swf">
                        <param name="quality" value="high">
                        <param name="menu" value="false">
                        <embed src="<?php echo $video; ?>/brcmedia.swf" width="600" height="450" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" menu="false"></embed>
                      </object>
                        </noscript>                             <p><strong>
                              <?php include($info); ?>
                        </strong></p>
                        <p><img src="../imagenes/flechavolver.gif" alt="Volver a la página anterior" width="4" height="8"> <strong><a class="brcmedia" href="javascript:window.history.back();" title="Volver a la p&aacute;gina anterior">Volver a la sección de vídeos</a></strong></p>
                          </td>
                        </tr>
                      </table>
                      <p>&nbsp;</p>
